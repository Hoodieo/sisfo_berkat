    ...
    <div class="col-md-6">
        <form method="POST" id="form" data-form-status='<?= $_GET['form_status'] ?>'>
            <input type="hidden" name="id" id="id" class="form-control" value="<?= $id; ?>" />
                    ...
                    <div class="form-group">
                        <label for="content_materi">Foto Produk</label>
                        <input type="file" name="fileimage" id="fileimage" class="form-control" id="content_materi" name="content_materi" accept="image/*">
                        <input type="hidden" name="tmp_image_url" id="tmp_image_url" value="<?= $content; ?>" >
                        <small class="text-muted">Upload gambar format .jpg, .jpeg, .png atau .gif berukuran maksimal 1MB.</small class="text-muted">
                    </div>
