...
<script>
    ...
    laporanPreviewBtn.addEventListener('click', function(){
        ...
        if (_jenisLaporan === 'tahunan') {
            // get report
                $.ajax({
                    type	: "GET",
                    url		: "actions.php?action=preview_lap_pemesanan&laporan="+_jenisLaporan+"&tahun="+tahun.value,
            ...
            if (bulan.value) {
                ...
                $.ajax({
                    type	: "GET",
                    url		: "actions.php?action=preview_lap_pemesanan&laporan="+_jenisLaporan+"&bulan="+bulan.value,
                    success	: function(res){
                        previewContent.innerHTML = res
                    }
                });
            ...
            if (tanggal.value) {
                ...
                $.ajax({
                    type	: "GET",
                    url		: "actions.php?action=preview_lap_pemesanan&laporan="+_jenisLaporan+"&tanggal="+tanggal.value,
                    success	: function(res){
                        previewContent.innerHTML = res
                    }
                });
    ...
    laporanCetakBtn.addEventListener('click', function(){
        ...
        if (_jenisLaporan === 'tahunan') {
            window.location.href = "module/laporan_pemesanan/report?laporan="+_jenisLaporan+"&tahun="+tahun.value;
        } else if (_jenisLaporan === 'bulanan' ) {
            if (bulan.value) {
                validateBulan.textContent = '';
                window.location.href = "module/laporan_pemesanan/report?laporan="+_jenisLaporan+"&bulan="+bulan.value;
            } else {
                validateBulan.textContent = 'Bulan dan tahun harus dipilih';
            }
        } else {
            if (tanggal.value) {
                validateTanggal.textContent = '';
                window.location.href = "module/laporan_pemesanan/report?laporan="+_jenisLaporan+"&tanggal="+tanggal.value;
            } else {
                validateTanggal.textContent = 'Tanggal harus dipilih';
            }
        }
